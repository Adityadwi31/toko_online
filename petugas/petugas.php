              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-striped">
                    <thead>
                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#tambah_pelanggan">Tambah Petugas
                        <th>NO</th>
                    ...
                    <tbody>
                      ...
                      while ($data = mysqli_fetch_array($qry)) {
                        ...
                        <tr>
                          ...
                          <td><?= $data['level'] ?></td>
                          <td>
                            <a href="u_petugas.php?id_petugas=<?= $data['id_petugas'] ?>" class="btn btn-success">Ubah Data</a> |
                            <a href="h_petugas.php?id_petugas=<?= $data['id_petugas'] ?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')" class="btn btn-danger">Hapus</a>
                          </td>
                        </tr>
                      <?php
                      }
                        ...
                        <div class="card-body">
                          <form class="forms-sample" action="pt_petugas.php" method="post" enctype="multipart/form-data">
                            <div class="form-group row">
                              ...
                              <div class="col-sm-9">
                                <input type="text" name="nama_petugas" class="form-control form-control-sm" id="exampleInputUsername2" placeholder="Nama">
                              </div>
                            </div>

              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <table class="table table-striped">
                    <thead>
                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#tambah_pelanggan">Tambah Pelanggan</button><br>
                      <tr>
                        <th> NO </th>
                    ...
                    <tbody>
                      ...
                      while ($data = mysqli_fetch_array($qry)) {
                        ...
                        <tr>
                          ...
                          <td><?= $data['alamat'] ?></td>
                          <td><?= $data['telp'] ?></td>
                          <td><img src="../images/pelanggan/<?= $data['foto_pelanggan'] ?>" alt="$data['nama']?>" ></td>
                          <td><a href="u_pelanggan.php?id_pelanggan=<?= $data['id_pelanggan'] ?>" class="btn btn-success">Ubah Data</a> |  
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Register pelanggan</h5>

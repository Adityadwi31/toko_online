            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <form class="forms-sample" action="pu_pelanggan.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
                            <img src="../images/pelanggan/<?= $dt_pelanggan['foto_pelanggan'] ?>" alt="$dt_pelanggan['nama']?>" style="width:100px;height:100px;">
                            <br><br>
                            <input type="file" name="foto" class="form-control">
                            <input type="hidden" name="foto1" value="<?= $dt_pelanggan['foto_pelanggan'] ?>">
                          </div>
                        </div>
                        <input type="submit" name="submit" value="Ubah Pelanggan" class="btn btn-primary  mr-2">
                        <a href="pelanggan.php" class="btn btn-">Cancel</a>
                      </form>
                    </div>
                    <br>
                  </div>
